...
namespace VarastoApi.Backend {
    public class DatabaseLauta {
        ...
        public bool InsertInto(Lauta m) {
            try {
                sql = "Insert into mydb.Lauta(Koko, Hinta, Määrä, Yksikkö, Sijainti, Kauppa, Lisätiedot) values ('" + m.Koko + "', '" + m.Hinta + "', '" + m.Maara + "', '" + m.Yksikko + "', '" + m.Sijainti + "', '" + m.Sijainti + "', '" + m.Kauppa + "', '" + m.Lisatiedot + "');";
