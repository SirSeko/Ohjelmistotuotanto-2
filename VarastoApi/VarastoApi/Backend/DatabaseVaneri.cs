...
namespace VarastoApi.Backend {
    public class DatabaseVaneri {
        ...
        public bool Update(Vaneri v) {
            try {
                sql = "UPDATE mydb.Vaner SET Koko='" + v.Koko + "', Hinta='" + v.Hinta + "', Määrä='" + v.Maara + "', Yksikkö='=" + v.Yksikko + "', Sijainti='" + v.Sijainti + "', Kauppa='" + v.Kauppa + "', Lisätiedot='" + v.Lisatiedot + "' WHERE VaneriID='" + v.Id + "';";
