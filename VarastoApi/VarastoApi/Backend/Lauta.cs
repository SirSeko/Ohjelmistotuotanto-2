...
namespace VarastoApi.Backend {
    public class Lauta {
        ...
        private Lauta(int id, string koko, float hinta, int maara, string yksikko, int sijainti, string kauppa, string lisatiedot) {
            Id = id;
            Koko = koko;
            Hinta = hinta;
            Maara = maara;
        ...
        public Lauta Create(int id, string koko, float hinta, int maara, string yksikko, int sijainti, string kauppa, string lisatiedot) {
